...
const Footer = () => {
  return (
    <div className="mb-2 font-used">
      <footer className="footer p-10 bg-[#0b1315] text-white">
        <div>
          <p>
            <span className="text-White text-2xl font-bold font-used">Melody Mentor</span>
            <br />
            <br />
        ...
        <div>
          ...
          <div className="flex flex-wrap justify-end mt-2 ">
            <Link to="#" className="btn btn-circle btn-outline ml-2 mb-2 sm:mb-0 hover:bg-pink-700">
