                    ...
                    <tbody>
                        {
                            ...
                            >
                                ...
                                <td>
                                    <button onClick={() => handlePay(classItem)} className="btn btn-warning btn-sm">PayMent</button>
                                </td>
                                <td>
                                    <button onClick={() => handleDelete(classItem)} className="btn btn-outline bg-pink-800 text-white "><FaTrashAlt></FaTrashAlt></button>
                                </td>
                            </tr>)
                        }
